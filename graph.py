...
if __name__ == "__main__":
    ...
    node_df = load_succession_data.make_df_from_graph_nodes(load_succession_data.load_succession_into_forward_dict(verbose=False), load_succession_data.load_succession_into_reverse_dict(verbose=False), verbose=False)
